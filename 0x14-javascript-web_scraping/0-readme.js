...
const fs = require('fs');
//important the  buil-in Node.js 'fs' module.

fa.readFile (process.argv[2], 'utf8', function (error, content) {
...
if (error) {
	...
	// If the file is read successfully, the 'content' parameter will contain the file as a string .
	console.log(content);
}
});
